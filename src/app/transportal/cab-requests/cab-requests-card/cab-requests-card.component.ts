...
@Component({
  selector: 'app-cab-requests-card',
  templateUrl: './cab-requests-card.component.html',
  styleUrls: ['./cab-requests-card.component.css'],
  providers: [MessageService]
})
export class CabRequestsCardComponent implements OnInit { 
